...
class create(data.Dataset):
    def __init__(self, data_root1, data_root2,transforms=None, train=True, test=False):
        ...
        if self.train:
            ...
            self.datas1 = datas1[int(0* len(datas1)):int(0.3 * len(datas1)):3]
            self.datas2 = datas2[int(0* len(datas2)):int(0.3 * len(datas2)):3]
...
class create_val(data.Dataset):
    def __init__(self, data_root1, data_root2,transforms=None, train=True, test=False):
        ...
        self.train =train
        if self.train:
            self.datas1 = datas1[int(0.1* len(datas1)):int(0.8* len(datas1)):3]
            self.datas2 = datas2[int(0.1* len(datas2)):int(0.8* len(datas2)):3]

        elif self.test:
            self.datas1 = datas1[int(0.9 * len(datas1)):]
            self.datas2 = datas2[int(0.9 * len(datas2)):]
        else:
            self.datas1 = datas1[int(0.8* len(datas1)):int(1 * len(datas1)):2]+datas1[int(0* len(datas1)):int(0.1* len(datas1)):2]
            self.datas2 = datas2[int(0.8* len(datas2)):int(1 * len(datas2)):2]+datas2[int(0* len(datas2)):int(0.1* len(datas2)):2]
...
class create_cross_val(data.Dataset):
    def __init__(self, data_root1, data_root2,transforms=None, train=True, test=False):
        self.test = test
        # data_root = os.path.join(data_root, 'TrainingImg')
        # target_root = os.path.join(data_root, 'TrainingMask')
