...
class C_Net_(nn.Module):
    def __init__(self, img_ch=4,feature_ch=16, output_ch=1):
        ...
        # self.Conv5_1 = conv_block(feature_ch*8, feature_ch*16)
        # self.Conv4_1 = conv_block(feature_ch*4, feature_ch*8)
        # self.Conv3_1 = conv_block(feature_ch*2, feature_ch*4)

        # self.Conv5_2 = conv_block(feature_ch*8, feature_ch*16)
        # self.Conv4_2 = conv_block(feature_ch*4, feature_ch*8)
        # self.Conv3_2 = conv_block(feature_ch*2, feature_ch*4)
    ...
    def forward(self, x1,x2):
        ...
        # cl12,cam12 = self.CAM_G(x32,x52,self.bott31,self.bott51)

        cl21,cam21 = self.CAM_G(x31,x51,self.bott32,self.bott52)
        # cl22,cam22 = self.CAM_G(x32,x52,self.bott32,self.bott52)
        ...
        # cl_co12,cam_co12 = self.CAM_G(x_co32,x_co52,self.bott31_,self.bott51_)

        cl_co21,cam_co21 = self.CAM_G(x_co31,x_co51,self.bott32_,self.bott52_)
        # cl_co22,cam_co22 = self.CAM_G(x_co32,x_co52,self.bott32_,self.bott52_)
